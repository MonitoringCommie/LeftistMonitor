...
const categories: CategorySection[] = [
  {
    ...
    topics: [
      {
        title: '3D Globe',
        description: 'Interactive 3D globe with wars, conflicts, and liberation struggles',
        path: '/map',
        accent: '#C41E3A',
      ...
      },
      {
        ...
        description: 'Books, pamphlets, and political writings',
        path: '/books',
        accent: '#8B6914',
        iconPath: icons.book,
      },
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '80rem', margin: '0 auto', padding: '3rem 1.5rem' }}>
          ...
          <p style={{
            ...
            Tracking left-wing politics, parties, elections, conflicts, and movements worldwide.
          </p>
        </div>
      </header>
